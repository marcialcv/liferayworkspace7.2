package com.liferay.mcv.document.library.audit;

import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.AUDIT_CLASSNAME;
import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.COMPANY_ID_ATTR;
import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.DESCRIPTION_ATTR;
import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.DL_FILE_ENTRY_TYPE_NAME;
import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.DL_FILE_ENTRY_TYPE_NAME_ATTR;
import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.FILE_ENTRY_ID;
import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.GROUP_ID_ATTR;
import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.IN_TRASH_ATTR;
import static com.liferay.mcv.document.library.audit.constants.DocumentLibraryAuditConstants.TITLE_ATTR;
