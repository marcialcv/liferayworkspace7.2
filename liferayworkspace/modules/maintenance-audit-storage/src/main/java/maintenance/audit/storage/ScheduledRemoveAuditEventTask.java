package maintenance.audit.storage;
...
@Component(immediate = true, property = {
		"cron.expression=00 00 00 L */3 ? *" }, service = ScheduledRemoveAuditEventTask.class)
public class ScheduledRemoveAuditEventTask extends BaseMessageListener {
	...
	private static final Log _log = LogFactoryUtil.getLog(ScheduledRemoveAuditEventTask.class);
